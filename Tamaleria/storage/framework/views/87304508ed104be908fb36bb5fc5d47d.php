...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Gestion Orden'); ?></title>

    <link href='https://unpkg.com/boxicons@2.1.4/css/boxicons.min.css' rel='stylesheet'>
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.6.0/css/all.min.css">
    <link href="https://fonts.googleapis.com/css2?family=Material+Symbols+Rounded" rel="stylesheet">
    <link rel="stylesheet" href="<?php echo e(asset('css/gestion-user.css')); ?>">
...
<body>
    ...
    <script src="<?php echo e(asset('js/orden-gestion.js')); ?>"></script>
    <script type="module" src="https://unpkg.com/ionicons@7.1.0/dist/ionicons/ionicons.esm.js"></script>
    <script nomodule src="https://unpkg.com/ionicons@7.1.0/dist/ionicons/ionicons.js"></script>
</body>
</html>
<?php /**PATH C:\Users\luis moguel\Desktop\tamaleria\resources\views/layouts/gestion-orden.blade.php ENDPATH**/ ?>