...
<div id="page" class="site">
    <div class="ccontainer">
        <div class="form-box">
            ...
            <form action="<?php echo e(route('ordenes.update', $orden->orden_id)); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                ...
                <div class="form-one form-step active">
                    ...
                    <div>
                        ...
                        <input type="date" name="fecha_orden" id="fecha_orden" value="<?php echo e(old('fecha_orden', $orden->fecha_orden)); ?>" required>
                    </div>

                    <div>
                        <label>Total de la Orden</label>
                        <input type="number" name="total_orden" id="total_orden" step="0.01" min="0" value="<?php echo e(old('total_orden', $orden->total_orden)); ?>" required>
                    </div>

                    <div>
                        <label>Descripción</label>
                        <input type="text" name="descripcion" id="descripcion" maxlength="255" value="<?php echo e(old('descripcion', $orden->descripcion)); ?>" required>
                    </div>
                    ...
                    <div>
                        ...
                        <select name="cupon_id">
                            ...
                            <?php $__currentLoopData = $cupones; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cupon): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($cupon->cupon_id); ?>" <?php echo e(old('cupon_id', $orden->cupon_id) == $cupon->cupon_id ? 'selected' : ''); ?>>
                                    <?php echo e($cupon->codigo); ?>
                    ...
                    <div class="file-upload">
                        ...
                        <div id="file-name" class="file-name">
                            <?php echo e($orden->imagen ? basename($orden->imagen) : 'Nombre de la imagen'); ?>

                        </div>

                        <?php if($orden->imagen): ?>
                            <div style="margin-top: 10px;">
                                <img src="<?php echo e(asset('storage/' . $orden->imagen)); ?>" alt="Comprobante" width="150">
                            </div>
                        <?php endif; ?>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.ordenes', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\luis moguel\Desktop\tamaleria\resources\views/ordenes/edit.blade.php ENDPATH**/ ?>